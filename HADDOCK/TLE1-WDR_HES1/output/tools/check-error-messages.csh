...
set found=`tail -n 500 $1 | grep -c "ALLHP error encountered: not enough memory available"`
...
set found=`tail -n 500 $1 | grep "error encountered: missing SCATter definition for SELEcted atoms" | wc -l | awk '{print $1}'`
