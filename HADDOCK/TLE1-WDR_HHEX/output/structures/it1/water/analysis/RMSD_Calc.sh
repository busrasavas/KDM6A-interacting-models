...
then
  ...
  if [ $found -eq 0 ]
  then
     export PROFIT="/home/enmr/software/bin/profit"
  else
...
then
    ...
    then
        ...
        echo "Set the PYTHON variable at the beginning of the script to your Python installation."
        exit
    fi
        ...
        then
            ...
            do
                ...
                then
                    ...
                    difference=`$PYTHON -c 'print " ".join(set("'"$res_A"'".split()).symmetric_difference("'"$res_B"'".split()))'`
